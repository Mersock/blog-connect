...
class EditProfile extends React.Component {
    ...
    handleSubmit = event => {
        ...
        updateUser(this.state._id, this.userData).then(updateUser => {
            this.setState({updateUser, openSuccess: true});

            setTimeout(() => Router.push({
                pathname: '/profile',
                query: { userId: this.state._id },
            },`/profile/${this.state._id}`), 3000);
    ...
    render() {
        ...
        const {name, email, avatar, about, isLoading, avatarPreview, isSaving, updateUser, openSuccess, openError, error} = this.state;
            ...
            <div className={classes.root}>
                <Paper className={classes.paper}>
                    ...
                    >
                        ...
                        <DialogContent>
                            <DialogContentText>
                                User {updateUser && updateUser.name} successfully updated!
                            </DialogContentText>
                        </DialogContent>
                    </Dialog>
